...
const uint16_t characterData[] = { 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x6030, 0x6030, 0x6030, 0x6030, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xF2F6, 0x6030, 0x6030, 0xF2F6, 0x6030, 0x6030, 0x6030, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0x6030, 0xFFFF, 0x6E32, 0xF2F6, 0x6E32, 0xFFFF, 0x6030, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xF2F6, 0xF2F6, 0xFFFF, 0x6E32, 0xF2F6, 0x6E32, 0xFFFF, 0x6030, 0xE007, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xF2F6, 0xF2F6, 0xF2F6, 0xF2F6, 0xF2F6, 0xF2F6, 0xF2F6, 0x6030, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0xE0F9, 0xE0F9, 0x1392, 0xF2F6, 0xF2F6, 0xF2F6, 0xF2F6, 0xF2F6, 0xE0F9, 0x6030, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0x1DDB, 0x1DDB, 0x1DDB, 0x1392, 0x1392, 0x1392, 0x1392, 0x1392, 0xE0F9, 0x6030, 0xE007, 0xE007, 0x6030, 0xE0F9, 0xE0F9, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1392, 0x6030, 0xE007, 0xE007, 0x6030, 0xE0F9, 0x1DDB, 0x1DDB, 0x1392, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x6030, 0x6030, 0xE007, 0x6030, 0xE0F9, 0x1DDB, 0x1DDB, 0x1DDB, 0x1392, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0xEFD5, 0xF2F6, 0x6030, 0x6030, 0xE0F9, 0x1DDB, 0x1DDB, 0x1DDB, 0xF2F6, 0xF2F6, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0xEFD5, 0xF2F6, 0x6030, 0x6030, 0xE0F9, 0xE0F9, 0x1392, 0x1DDB, 0xF2F6, 0xF2F6, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x6030, 0x6030, 0xE007, 0xE007, 0x6030, 0x6030, 0x1392, 0x1392, 0x1392, 0x1392, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x1DDB, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x1342, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x1342, 0x1342, 0x1342, 0x6030, 0x6030, 0x1342, 0x1342, 0x1342, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x1342, 0x1342, 0x1342, 0x6030, 0x6030, 0x1342, 0x1342, 0x1342, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0x1342, 0x1342, 0x1342, 0x6030, 0x6030, 0x1342, 0x1342, 0x1342, 0x6030, 0xE007, 0xE007, 0xE007, 0xE007, 0xE007, 0x6030, 0xE649, 0xE649, 0xE649, 0xE649, 0x6030, 0xE649, 0xE649, 0xE649, 0xE649, 0x6030, 0xE007 };
const int characterWidth = 15;
    ...
    if ((sliceY <= characterY + characterHeight) && (sliceY + SLICE_HEIGHT > characterY)) {
      ...
      for (int y = startIndex; y <= endIndex; y++) {
        ...
        for (int x = characterX; x < characterX + characterWidth; x++) {
          ...
          int value = characterData[(sliceY - characterY + y) * characterWidth - characterX + x];
          if (value != 0xE007) {
            buffer[x + y * W] = value;
          }
        }
